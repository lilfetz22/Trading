...
# import the file from here: C:\Users\WilliamFetzner\Documents\Trading\FinRL-Meta\meta\env_fx_trading\util
...
class tgym(gym.Env):
    ...
    4. Use StopLoss, ProfitTaken to realize rewards. each pair can configure its own SL and PT in configure file
    ...
    17. reward is forex trading unit Point, it can be configured for each trading pair
    """
